...
export class ProcessesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProcessesProcessIdDownloadFileProcessGet(processId: number, departmentId?: string, token?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<InlineResponse20012>;
    public apiProcessesProcessIdDownloadFileProcessGet(processId: number, departmentId?: string, token?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<InlineResponse20012>>;
    public apiProcessesProcessIdDownloadFileProcessGet(processId: number, departmentId?: string, token?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<InlineResponse20012>>;
    public apiProcessesProcessIdDownloadFileProcessGet(processId: number, departmentId?: string, token?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse20012>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProcessesUnlockProcessFilesPost(token?: string, processesUnlockProcessFilesBody?: ProcessesUnlockProcessFilesBody, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<InlineResponse20013>;
    public apiProcessesUnlockProcessFilesPost(token?: string, processesUnlockProcessFilesBody?: ProcessesUnlockProcessFilesBody, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<InlineResponse20013>>;
    public apiProcessesUnlockProcessFilesPost(token?: string, processesUnlockProcessFilesBody?: ProcessesUnlockProcessFilesBody, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<InlineResponse20013>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProcessesUpdateDateAndReferencePost(token?: string, processesUpdateDateAndReferenceBody?: ProcessesUpdateDateAndReferenceBody, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<InlineResponse20011>;
    public apiProcessesUpdateDateAndReferencePost(token?: string, processesUpdateDateAndReferenceBody?: ProcessesUpdateDateAndReferenceBody, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<InlineResponse20011>>;
    public apiProcessesUpdateDateAndReferencePost(token?: string, processesUpdateDateAndReferenceBody?: ProcessesUpdateDateAndReferenceBody, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<InlineResponse20011>>;
